...
You must to install the Statics and Machine learning toolbox in your matlab. Otherwise, cannot be used to generate chi-square distribution.
Download the full folder and unzip.
enjoy!
# How to use
